...
const task = function (cb) {
  ...
  const CryptoAssetsCardList = 'widgets/mbwd-assets/components/js/mbwd-crypto-assets/mbwd-crypto-asset-card-list.js';
  const CryptoAssetsTable = 'widgets/mbwd-assets/components/js/mbwd-crypto-assets/mbwd-crypto-asset-table.js';

  // Crypto Components (Dependency:2)
  const CryptoAssets = 'widgets/mbwd-assets/components/js/mbwd-crypto-assets/mbwd-crypto-assets.js';

  // Fixed Income Components (Dependency:3)
  const FixedIncomeAssetsCardList = 'widgets/mbwd-assets/components/js/mbwd-fixed-income-assets/mbwd-fixed-income-asset-card-list.js';
  const FixedIncomeAssetsTable = 'widgets/mbwd-assets/components/js/mbwd-fixed-income-assets/mbwd-fixed-income-asset-table.js';

  // Fixed Income Components (Dependency:2)
  const FixedIncomeAssets = 'widgets/mbwd-assets/components/js/mbwd-fixed-income-assets/mbwd-fixed-income-assets.js';
