...
const task = function(cb) {
    // Modules
    const MostValuedAssetsComponentPath = 'widgets/mbwd-most-valued-assets/components/js/mbwd-most-valued-assets.js';
    const MainComponentJSpath = 'widgets/mbwd-most-valued-assets/components/js/main.js';
