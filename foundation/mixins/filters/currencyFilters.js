...
const currencyFilters = {
    filters: {
        ftFormatCrypto(v, maxDigits, scale) {
            ...
            return new Intl.NumberFormat("pt-BR",{ minimumFractionDigits: fixedDigits, maximumFractionDigits: fixedDigits }).format(Number(v).toFixedNoRounding(fixedDigits));
        },
        ftFormatCurrency(v, maxDigits, hideSymbol) {
            ...
            return new Intl.NumberFormat('pt-BR', options).format(Number(v).toFixedNoRounding(fixedDigits));
        },
